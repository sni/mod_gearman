Gearman Module for Nagios / Icinga
==================================
...
of distributing active Nagios/Icinga checks across your network and
...
http://labs.consol.de/wp-content/uploads/2010/09/Mod-Gearman.pdf[Have a look at the slides of the last Mod-Gearman presentation on the Nagios Workshop 2011 in Hannover]
...
Download
--------
 * Latest stable http://labs.consol.de/wp-content/uploads/2010/09/mod_gearman-1.2.6.tar.gz[version 1.2.6], released March 15 2012
...
Just copy the gearman_proxy.pl from the contrib directory and adjust
the first few lines to match you needs.
 ...
 * http://sourceforge.net/projects/nagios/files/nagios-3.x/nagios-3.2.3/[Nagios 3.2.3]

Icinga
~~~~~~
Mod-Gearman has succesfully been tested on Icinga 1.2.0 and is running
perfectly on up to the current version 1.6.1.

 * http://sourceforge.net/projects/icinga/files/icinga/1.6.1/[Icinga 1.6.1]
