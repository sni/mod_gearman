...
Download
--------
 * Latest stable http://labs.consol.de/wp-content/uploads/2010/09/mod_gearman-1.2.0.tar.gz[version 1.2.0], released January 08 2012
 ...
 * Mod-Gearman has been succesfully tested with latest Nagios/Icinga.
   See <<_supported_dependencys,Supported Dependencys>> for details.
...
now start and check your installation
--------------------------------------
...
Embedded Perl
-------------
Since 1.1.2 Mod-Gearman has builtin embedded Perl support which means
