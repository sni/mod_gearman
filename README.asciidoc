...
Download
--------
 * Latest stable release http://www.mod-gearman.org/download/v3.0.0/src/mod_gearman-3.0.0.tar.gz[version 3.0.0], released Februar 25 2016
...
--------------------------------------
broker_module=/usr/local/share/naemon/mod_gearman.o keyfile=/usr/local/share/naemon/secret.txt server=localhost eventhandler=yes hosts=yes services=yes config=.../module.conf
--------------------------------------
...
achieve this with the following neb module settings:
 ...
 broker_module=/usr/local/share/naemon/mod_gearman.o server=localhost encryption=no eventhandler=no hosts=no services=no hostgroups=does_not_exist config=.../module.conf
 ...
 * http://naemon.org[Naemon]


Nagios
~~~~~~
Mod-Gearman works well with Nagios 3. Preferable version 3.2.3
or 3.5.1.
...
Icinga
~~~~~~
The Icinga core is not really supported by Mod-Gearman. However, people have
reported it works with Icinga 1.2.0, 1.8 and 1.10.1 but it seems like some
...
* http://www.mod-gearman.org/download/v2.1.5/src/mod_gearman2-2.1.5.tar.gz[version 2.1.5 - September 30 2015]
* http://www.mod-gearman.org/download/v2.1.4/src/mod_gearman2-2.1.4.tar.gz[version 2.1.4 - August 28 2015]
* http://www.mod-gearman.org/download/v2.1.3/src/mod_gearman2-2.1.3.tar.gz[version 2.1.3 - July 01 2015]
* http://www.mod-gearman.org/download/v2.1.2/src/mod_gearman2-2.1.2.tar.gz[version 2.1.2 - February 13 2015]
* http://www.mod-gearman.org/download/v2.1.1/src/mod_gearman2-2.1.1.tar.gz[version 2.1.1 - January 20 2015]
* http://www.mod-gearman.org/download/v2.1.0/src/mod_gearman2-2.1.0.tar.gz[version 2.1.0 - January 17 2015]
* http://www.mod-gearman.org/download/v2.0.0/src/mod_gearman2-2.0.0.tar.gz[version 2.0.0 - December 11 2015]
