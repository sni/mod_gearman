...
Download
--------
 * Latest stable for Naemon http://www.mod-gearman.org/download2/v2.1.5/src/mod_gearman2-2.1.5.tar.gz[version 2.1.5], released September 30 2015
 * Latest stable for Nagios 3 http://www.mod-gearman.org/download/v1.5.5/src/mod_gearman-1.5.5.tar.gz[version 1.5.5], released September 30 2015
