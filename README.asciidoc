...
* Latest stable release http://labs.consol.de/wp-content/uploads/2010/09/mod_gearman-1.1.1.tar.gz[version 1.1.1] from November 10 2011
 ...
 * https://launchpad.net/gearmand/trunk/0.25[0.25]
 * https://launchpad.net/gearmand/trunk/0.23[0.23]
 * https://launchpad.net/gearmand/trunk/0.14[0.14]
...
And they do not affect Mod-Gearman as well as they are only in the
