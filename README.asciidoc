 ...
 * Mod-Gearman 4.x works with Naemon Core
 ...
 * https://www.naemon.org/documentation/usersguide/embeddedperl.html[Embedded Perl]
 * https://www.naemon.org/documentation/usersguide/epnplugins.html[Plugin Guidelines]
